...
int main ()
{
	...
	{
		/*-----------------------------------------------------------------
			Leemos la palabra recibida e imprimimos lo que quiera 
		------------------------------------------------------------------*/
	...
	stTm = localtime(&tiempo);
			...
			if(strcmp(cadena, "DAY") == 0){
				strftime(cadena,256,"%A, %d de %B de %Y", stTm);
				printf("Cadena: %s\n", cadena);
			}
				...
				strftime(cadena,256,"%A, %d de %B de %Y;%H:%M:%S", stTm);
				printf("Cadena: %s\n", cadena);
			}
			else if(strcmp(cadena, "DAY") == 0){
				printf("Error, la palabra recibida debe ser: DAY | TIME | DAYTIME\n");	
			}
